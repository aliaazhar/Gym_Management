...
SECRET_KEY = 'django-insecure-f2pz66oo++rc!z++)=pif#7=aa-_0cb-@&h-!k5*l=uz9w1-0g'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')],        # i cnaged this line
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Use default static file storage for development
